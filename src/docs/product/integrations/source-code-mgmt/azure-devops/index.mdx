...
### Insufficient account access

![installation-error](https://github.com/getsentry/sentry-docs/assets/8451987/8965cc07-5618-4626-bed0-a368dcc46463)

If you are attempting intall the Azure DevOps integration and have the correct Azure organization owner permissions or being a user in the Project Collections Administrators, please ensure you check "Third-party application access via OAuth" checkbox under the organization settings to avoid the above error.

![](https://github.com/getsentry/sentry-docs/assets/8451987/8842be67-0ab7-45d2-8ece-2d7058ca7497)
