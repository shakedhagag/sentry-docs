...
When enabling this option, we recommended carefully reviewing details sent to Sentry and using our features for managing [_Sensitive Data_](../../data-management/sensitive-data/).
...
<ConfigKey name="enableOutOfMemoryTracking" supported={["react-native", "javascript.capacitor", "flutter"]}>
